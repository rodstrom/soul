...
namespace Soul
{
    class DarkWhisper : Entity
    {
        ...
        private void CreateSpikes()
        {
            ...
            pos.Y -= offset.Y;
            velo.Y = -spikeSpeed;
            Bullet spike = new Bullet(randomizer, spikeRange, spriteBatch, game, pos, velo, Constants.DARK_WHISPER_SPIKE_FILENAME, "dark_whisper_spike", EntityType.DARK_WHISPER_SPIKE, spikeDamage);
            spike.setRotation(0f);
            spikeList.Add(spike);
            pos.X += offsetHalf.X;
            pos.Y += offsetHalf.Y;
            velo.X = spikeSpeed;
            spike = new Bullet(randomizer, spikeRange, spriteBatch, game, pos, velo, Constants.DARK_WHISPER_SPIKE_FILENAME, "dark_whisper_spike", EntityType.DARK_WHISPER_SPIKE, spikeDamage);
